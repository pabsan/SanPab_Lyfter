...
BEGIN
    ...
    IF row_count = 0 THEN
        ...
        INSERT INTO vehiculos (marca, modelo, ano, estado) VALUES ('Mercedes-Benz', 'SL-Class', 2002, 'Ocupado');
        ...
        INSERT INTO vehiculos (marca, modelo, ano, estado) VALUES ('Lincoln', 'Continental Mark VII', 1990, 'Ocupado');
        ...
        INSERT INTO vehiculos (marca, modelo, ano, estado) VALUES ('Chevrolet', 'Suburban 1500', 2008, 'Ocupado');
        ...
        INSERT INTO vehiculos (marca, modelo, ano, estado) VALUES ('Pontiac', 'Grand Prix', 2002, 'Ocupado');
        ...
        INSERT INTO vehiculos (marca, modelo, ano, estado) VALUES ('Lotus', 'Esprit', 2004, 'Ocupado');
